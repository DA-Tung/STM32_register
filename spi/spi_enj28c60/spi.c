...
//	SPIx->CR1 &= ~SPI_CR1_SPE;
	...
	// Select full duplex (write and read)
...
// SPI write_______________________________________________________________
...
// SPI readR_______________________________________________________________
